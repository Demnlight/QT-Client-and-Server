#include "CCustomShadowEffect.h"
#include <QPainter>
// #include <QGraphicsEffect>

CCustomShadowEffect::CCustomShadowEffect(QObject *parent) :
...
void CCustomShadowEffect::draw(QPainter* painter)
{
    ...
    QSize szi(px.size().width() + 4 * distance(), px.size().height() + 4 * distance());
...
QRectF CCustomShadowEffect::boundingRectFor(const QRectF& rect) const
{
